<template>
  <ButtonGroup size="small">
    <Button :disabled="notSelectOneMode()" @click="flip('X')">
      <svg class="icon" height="14" p-id="1549" t="1650443094178" version="1.1"
        ...
        <path d="M477.48096 85.34528l70.87104 0 0 885.80608-70.87104 0 0-885.80608Z" p-id="1551"></path>
        <path
    ...
    <Button :disabled="notSelectOneMode()" @click="flip('Y')">
      <svg class="icon" height="14" p-id="1749" t="1650443104385" version="1.1"
           viewBox="0 0 1024 1024" width="14" xmlns="http://www.w3.org/2000/svg">
        <path d="M286.01856 250.91584l472.4224 0 0 146.2784-472.4224 0 0-146.2784Z" p-id="1750"></path>
        <path d="M87.19872 475.62752l885.80096 0 0 70.87104-885.80096 0 0-70.87104Z" p-id="1751"></path>
        <path
...
export default {
  ...
  methods: {
    ...
    flip (type) {
      ...
      this.canvas.c.requestRenderAll() // 重新渲染
    }
  }
}
</script>
