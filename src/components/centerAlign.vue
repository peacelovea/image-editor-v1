<template>
  <ButtonGroup size="small">
    ...
    <Button :disabled="!mSelectMode" @click="position('centerH')">
      <svg class="icon" height="14" p-id="3787" t="1650442559691" version="1.1"
           viewBox="0 0 1024 1024" width="14" xmlns="http://www.w3.org/2000/svg">
        <path d="M885 607H544V417h192V227H544V24h-64v203H288v190h192v190H139v190h341v203h64V797h341z"
              p-id="3788"></path>
      </svg>
    </Button>
    <!-- 水平垂直居中 -->
    <Button :disabled="!mSelectMode" @click="position('center')">
      <svg class="icon" height="14" p-id="2351" t="1650852784867" version="1.1"
           viewBox="0 0 1024 1024" width="14" xmlns="http://www.w3.org/2000/svg">
        <path d="M544 480V64h-64v416H64v64h416v416h64V544h416v-64z" fill="#727272" p-id="2352"></path>
        <path
          ...
          fill="#B2B2B2" p-id="2353"></path>
      </svg>
    </Button>
    <!-- 垂直居中 -->
    <Button :disabled="!mSelectMode" @click="position('centerV')">
      <svg class="icon" height="14" p-id="3412" t="1650442510967" version="1.1"
           viewBox="0 0 1024 1024" width="14" xmlns="http://www.w3.org/2000/svg">
        <path
